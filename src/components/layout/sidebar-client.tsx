    ...
    >
      ...
      <Icon
        className={[
          ...
          active ? 'text-primary' : 'text-sidebar-foreground/60 group-hover:text-foreground',
        ].join(' ')}
      />
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="px-3 pt-3 pb-2">
        <button
          type="button"
          className="flex w-full items-center gap-2 rounded-lg border border-sidebar-border bg-accent/30 px-3 py-2 text-[13px] text-muted-foreground transition-colors hover:border-primary/20 hover:text-foreground"
        >
          <Search className="h-3.5 w-3.5 shrink-0" />
          <span className="flex-1 text-left">Buscar…</span>
          <kbd className="rounded border border-sidebar-border bg-background/50 px-1.5 py-0.5 text-[10px] font-medium opacity-60">
            ⌘K
          </kbd>
        </button>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-2 scrollbar-none space-y-5">
        ...
        <div>
          <p className="eyebrow px-3 pb-2 text-[10px]">Workspace</p>
          <div className="space-y-0.5">
        ...
        <div>
          <p className="eyebrow px-3 pb-2 text-[10px]">Análise</p>
          <div className="space-y-0.5">
      ...
      <div className="border-t border-sidebar-border p-3">
        ...
        >
          <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-primary/15 text-[10px] font-bold text-primary ring-1 ring-primary/20">
            {initials}
          </span>
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 z-50 flex w-[min(82vw,16rem)] flex-col border-r border-sidebar-border bg-sidebar lg:hidden"
              style={{
            ...
            >
              <button
                ...
                className="absolute right-3 top-4 z-10 flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-accent hover:text-foreground"
              >
                <X className="h-4 w-4" />
              </button>
